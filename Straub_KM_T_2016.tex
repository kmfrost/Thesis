...
Using this model, another suite of statistics can be calculated about the people in the graph.  The gasphs were modeled in python.  The graph library networkx \cite{hagberg-2008-exploring} was used to calculate all graph features.
...
Partial graph hubs                           & Graph        & 0.589  \\
Full graph authorities                       & Graph        & 0.554  \\
Number of emails received as forwards        & Traffic      & 0.0.519  \\
Partial graph current flow closeness centrality & Graph     & 0.0.512  \\
Partial graph pagerank                       & Graph        & 0.512    \\
Percentage of emails sent with unique addresses & Traffic   & 0.51  \\
Number of emails received as carbon copies   & Traffic      & 0.5      \\
Full graph pagerank                          & Graph        & 0.492    \\
Average number of emails received per day    & Traffic      & 0.489    \\
Partial graph communicability betweenness centrality & Graph & 0.486  \\
Partial graph communicability centrality     & Graph        & 0.486    \\
Total number of emails per day               & Traffic      & 0.479    \\
Partial graph number of cliques              & Graph        & 0.47 \\
Percentage of emails received as forwards    & Traffic      & 0.451 \\
Number of emails sent as carbon copies       & Traffic      & 0.43 \\
Partial graph degree centrality              & Graph        & 0.429 \\
Partial graph closeness centrality           & Graph        & 0.429 \\
Partial graph average shortest paths         & Graph        & 0.429 \\ \bottomrule
\end{tabular}
}
\end{table}
...
Furthermore, the distinction between graudate students and research faculty is likley the lest clear.
This can be interpreted for two primary reasons.
...
Some phD students have been at the center as long or longer than some research faculty.
Some research faculty also take classes as they work towards higher degrees.
