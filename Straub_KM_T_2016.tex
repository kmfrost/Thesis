...
\begin{figure}[t]
    \centering
        ...
        \label{fig:loocv_conf_plot}
\end{figure}
\item These results can typically be improved by increasing the number of training data. 
...
\item Unsupervised pre-training can improve the efficency of training deep belief networks, as first described in \cite{hinton_recognize_2007}.
