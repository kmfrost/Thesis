...
There exists a list of ground truth job title labels for the Enron email corpus, enabling corporate hierarchy analysis.
...
There are several other types of centrality such as closeness, current-flow betweenness, and random-walk centrality~\cite{newman2005measure}.
