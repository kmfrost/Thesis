...
\begin{figure}[t]
    \centering
        ...
        \caption{Pie chart showing the distribution of classes in the dataset.}
...
\begin{itemize}
\item Confusion matrix - how to make more diagonal?
\item Standard supervised learning - how much more data is needed
\item What would I expect the results to be?
\item Analysis that proves with extra stuff and time it could be better
\end{itemize}
\section{Deep Learning}
\begin{itemize}
\item How to implement deep learning on a very large scale (1,000's of dimensions, terabytes of data)?  Find an analogous paper for comparison.
\item Unsupervised learning with deep belief network
\item Backpropogation with some labels to refine weights
\end{itemize}
