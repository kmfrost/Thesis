...
\subsection{Machine Learning Overview} \label{sec:MachineLearning}
...
Machine learning focuses on designing algorithms to train a machine to identify patterns and relationships from data~\cite{furnkranz2012foundations}.
...
Machine learning techniques are divided into two broad categories: unsupervised and supervised~\cite{barber2012bayesian}.
T
...
Unsupervised techniques are used when working with unlabeled data, and the goal is to accurately characterize the given data.
...
Although labeled data is often more difficult to obtain, supervised learning 

Note that there is a third type of learning: semi-supervised, which refers to working with data that is partially labeled.
This is most often relevant to cases with large amounts of data where a small percentage is able to be hand-labeled.
This thesis will revisit this concept when discussing future work in Chapter~\ref{FutureWork}.
